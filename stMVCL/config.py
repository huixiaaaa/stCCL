...
def set_arg():
    parser = argparse.ArgumentParser(description='Hyperparameter of MVInfoNCE')
    parser.add_argument('--seed', type=int, default=0, help='random seed')
    parser.add_argument('--latent_dim', type=int, default=64, help='default dim of latent embedding')
    parser.add_argument('--epoch', type=int, default=1000, help='training epoch')
    parser.add_argument('--lr', type=float, default=0.001, help='learning rate')
    parser.add_argument('--weight_decay', type=float, default=0.0001, help='default weight decay of optimizer')
